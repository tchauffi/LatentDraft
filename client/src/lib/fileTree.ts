...
/**
 * Merge the editable project files and the server-side session files
 * (generated figures, …) into one directory tree. Directories sort first,
 * then files alphabetically, with main.tex pinned to the top of the root.
 */
export function buildFileTree(editable: string[], generated: string[]): FileNode[] {
